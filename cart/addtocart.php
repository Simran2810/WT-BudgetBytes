         ...
         <tbody > 
            ...
            ?>
                      <tr>
                        ...
                        <td><input type="NUMBER" data-id="<?php echo $result->PRODUCTID;  ?>" class="cusqty" name="QTY<?php echo $result->PRODUCTID;  ?>" id="QTY<?php echo $result->PRODUCTID; ?>"  value="<?php echo $_SESSION['katerina_cart'][$i]['qty'] ?>"/>
                        ...
                        <input type="hidden" name="PRICE<?php echo $result->PRODUCTID;  ?>" id="PRICE<?php echo $result->PRODUCTID; ?>"  value="<?php echo $_SESSION['katerina_cart'][$i]['price'] ?>"/></td>
                        ...
                        <?php    
                             ...
                             echo '<a href="index.php?page=2" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Add Another Products</strong></a>';
                                ...
                                if (isset($_SESSION['cus_id'])){  
                                  ...
                                  echo '<button type="submit"  name="proceed" id="proceed" class="btn btn_katerina pull-right"   ><strong>Proceed And Checkout</strong><span class="glyphicon glyphicon-chevron-right"></button>';
                               
                                 }else{
                                   echo   '<button type="button" class="btn btn_katerina pull-right" data-target="#myModal" data-toggle="modal" name="btnorder"><strong>Proceed And Checkout</strong><span class="glyphicon glyphicon-chevron-right"></button>';
                                } 
                              }
                                  echo '</form>'; 
                ...
                <div class="panel-head" style="margin-left:3%"><h3>address</h3></div>
                 ...
                 <!--  <div class="form-group">
                  ...
                  <div class="modal-footer"><p align="left">&copy; Katerina Ordering System</p>
                    <button class="btn btn-default" data-dismiss="modal" type=
                    "button">Close</button> 
                    <button type="submit"  name="savecustomer"   class="submit btn btn_katerina" >Sign Up</button> 
                    <!-- <button class="btn btn_katerina"
