          ...
          <div class="panel-body">  
           ...
           <!--      <strong>
                  <div class="col-lg-8" style="margin-bottom:5%"> 
                   <div class="culomn4"><div style=" fornt-size:35px; float:left; width:200px">Name</div><div >:: <?php echo  $_SESSION['FIRSTNAME'].' '.$_SESSION['LASTNAME'] ; ?> </div></div>
                     <div class="culomn4"><div style="fornt-size:35px; float:left; width:200px">Address</div><div >:: <?php echo $_SESSION['ADDRESS']; ?></div></div>
                     <div class="culomn4"><div style="fornt-size:35px; float:left; width:200px">Conatct Number</div><div > :: <?php echo $_SESSION['CONTACTNUMBER'] ; ?></div></div>
                  </div>
                </strong>   -->
            ...
            <div class="container"> 
              <div class="row"> <h3  align="right" margin-right="20%">Total Price : &#8369 <span  id="sum">0.00</span></h3></div>  
                ...
                <button   name="submitorder"  id ="submitorder" class="btn btn_katerina pull-right"  onclick="validatedate()" ><strong>Save Order</strong> <span class="glyphicon glyphicon-chevron-right"></span></button> 
